...
export default function Register() {
    ...
    const inputClass = `w-full pl-11 pr-4 py-3.5 bg-white/5 border border-white/10 rounded-xl text-white text-sm font-medium placeholder-slate-600 outline-none transition-all focus:border-primary-500/60 focus:shadow-[0_0_0_3px_rgba(123,44,191,0.15)]`;
