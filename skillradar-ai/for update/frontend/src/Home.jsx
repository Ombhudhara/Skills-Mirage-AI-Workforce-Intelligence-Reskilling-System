...
import { Compass, LayoutDashboard, User, RefreshCw, ArrowRight, Globe, Zap, Shield, TrendingUp, BookOpen, Brain, ChevronDown, Radio } from 'lucide-react';
...
export default function Home() {
    ...
    return (
        <div className="min-h-screen text-white font-sans">
            ...
            <div
                className="fixed top-0 left-0 w-[360px] h-[360px] rounded-full pointer-events-none mix-blend-screen opacity-30 z-0"
                style={{
                    background: 'radial-gradient(circle, rgba(34,211,238,0.5) 0%, transparent 70%)',
                    transform: 'translate(calc(var(--mouseX, 50vw) - 180px), calc(var(--mouseY, 50vh) - 180px))'
                }}
            />
            ...
            <div
                ...
                style={{
                    ...
                    WebkitMaskImage: 'radial-gradient(160px circle at var(--mouseX, 50vw) var(--mouseY, 50vh), black 0%, transparent 100%)',
                    maskImage: 'radial-gradient(160px circle at var(--mouseX, 50vw) var(--mouseY, 50vh), black 0%, transparent 100%)'
                }}
            >
                MIRAGE
            </div>
            ...
            <nav className="relative z-50 flex items-center justify-between px-8 py-5 max-w-screen-xl mx-auto border-b border-white/5">
                ...
                <div className="flex items-center gap-4">
                    <Link to="/login" className="text-slate-400 hover:text-white text-xs font-bold tracking-widest uppercase transition-colors">
                        Sign In
                    </Link>
                    <Link to="/register"
            ...
            <section className="relative z-10 flex flex-col items-center justify-center min-h-[85vh] text-center px-4 max-w-5xl mx-auto pt-16 pb-8">
                ...
                <p className="text-slate-400 text-base md:text-lg max-w-2xl leading-relaxed mb-12 font-medium tracking-wide">
            ...
            <section id="features" className="relative z-10 py-20 max-w-screen-xl mx-auto px-8">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                    {[
                        ...
                        <div key={title} className={`glass-card p-8 group cursor-default transition-all ${glow}`}>
