    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 opacity-10 pointer-events-none overflow-hidden rounded-3xl">
                <div className="absolute inset-0" style={{ backgroundImage: 'radial-gradient(rgba(255,255,255,0.1) 1px, transparent 0)', backgroundSize: '40px 40px' }}></div>
            </div>

            {/* Map SVG Container */}
            <div className="relative w-full h-full flex items-center justify-center p-4" style={{ overflow: 'visible' }}>
                <svg
                    width="100%"
                    height="100%"
                    viewBox="0 10 700 1010"
                ...
                >
                    <defs>
                        ...
                        <linearGradient id="indiaGradient" x1="0" y1="0" x2="1" y2="1">
                            ...
                            <stop offset="100%" stopColor="rgba(15, 22, 40, 1)" />
                        </linearGradient>
                    </defs>
                    ...
                    {cities.map((city) => (
                        ...
                        >
                            ...
                            <circle
                                ...
                                fill={city.color}
                                filter="url(#cityGlow)"
                                className="group-hover/marker:scale-125 transition-transform duration-300"
                            ...
                            <circle
                                ...
                                stroke={city.color}
                                strokeWidth="2"
                                className="opacity-30 group-hover/marker:animate-ping"
                                style={{ transformOrigin: `${city.x}px ${city.y}px` }}
                            />
                            ...
                            <g className="opacity-0 group-hover/marker:opacity-100 transition-all duration-300 pointer-events-none">
                                ...
                                />
                                <text x={city.x + 25} y={city.y - 25} fill="white" fontSize="12" fontWeight="900" className="uppercase tracking-[0.2em]">
                                    {city.name}
                                </text>
                                <text x={city.x + 25} y={city.y - 7} fill="#94a3b8" fontSize="9" fontWeight="700">
                                    JOBS: <tspan fill="white" fontWeight="900">{city.jobs}</tspan>
                                </text>
                                <text x={city.x + 25} y={city.y + 6} fill={city.color} fontSize="9" fontWeight="900">
                                    GROWTH: {city.growth}
                                </text>
                                <rect x={city.x + 25} y={city.y - 12} width="110" height="1" fill="white" fillOpacity="0.1" />
                            </g>
                        </g>
                    ))}
                </svg>
            ...
            <div className="absolute top-8 right-8 flex flex-col items-end gap-2 pointer-events-none">
                <div className="bg-slate-900/40 border border-white/5 p-4 rounded-2xl backdrop-blur-md">
                    <div className="flex items-center gap-3 mb-1">
                        ...
                        <span className="text-[10px] font-black text-blue-400 uppercase tracking-[0.2em]">Neural Link Active</span>
                    </div>
                </div>
            </div>

            {/* Bottom Legend */}
            <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex items-center gap-8 bg-black/60 backdrop-blur-2xl px-10 py-4 rounded-full border border-white/10 shadow-3xl pointer-events-none">
                <div className="flex items-center gap-2">
                    <div className="w-1.5 h-1.5 rounded-full bg-blue-400"></div>
                    <span className="text-[9px] font-black text-slate-300 uppercase tracking-widest">Hover Nodes for Data</span>
                </div>
                <div className="flex items-center gap-2">
                    <div className="w-1.5 h-1.5 rounded-full bg-slate-900/20"></div>
                    <span className="text-[9px] font-black text-slate-300 uppercase tracking-widest">Click for Deep Packet Inspection</span>
                </div>
            </div>
        </div>
    );
